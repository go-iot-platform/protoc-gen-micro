...
The nitro generated code includes clients and handlers which reduce boiler plate code
...
If you see an error about `protoc-gen-nitro` not being found or executable, it's likely your environment may not be 
